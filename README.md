...
2.  **Batteries are the Secret MVP:** Even though they’re cheap, batteries and cables are our #1 sellers by volume. If we run out, customers might abandon their entire cart. I recommended an **automated re-order system** so we never hit zero.
3.  **The Lunch & Dinner Spikes:** Orders predictably spike at **12 PM and 7 PM**. To keep things moving, we should stagger warehouse shifts so we have the most people on the floor during those exact windows.
